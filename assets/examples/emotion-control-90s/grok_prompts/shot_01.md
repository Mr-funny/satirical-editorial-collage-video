...
Image 1, first frame: assets/examples/emotion-control-90s/shot_01_first.png.
Image 2, tail frame: assets/examples/emotion-control-90s/shot_01_tail.png.
...
New staged element or beat group: 90 SECONDS label.
Micro-timeline:
...
Save or copy the generated video exactly to: assets/examples/emotion-control-90s/shot_01.mp4.
Duration: 6 seconds.
Resolution: 720p.
