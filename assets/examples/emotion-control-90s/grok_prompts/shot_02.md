...
Image 1, first frame: assets/examples/emotion-control-90s/shot_02_first.png.
Image 2, tail frame: assets/examples/emotion-control-90s/shot_02_tail.png.
...
New staged element or beat group: brain furnace sticker.
Micro-timeline:
...
Save or copy the generated video exactly to: assets/examples/emotion-control-90s/shot_02.mp4.
Duration: 6 seconds.
Resolution: 720p.
