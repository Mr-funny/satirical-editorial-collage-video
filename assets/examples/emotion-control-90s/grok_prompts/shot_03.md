...
Image 1, first frame: assets/examples/emotion-control-90s/shot_03_first.png.
Image 2, tail frame: assets/examples/emotion-control-90s/shot_03_tail.png.
...
New staged element or beat group: red flame and crumpled thought fuel.
Micro-timeline:
...
Palette: keep deep crimson or rust-red panel, charcoal shadows, off-white torn paper, hot red flame accents consistent across all generated frames.
End on a stable frame close to image 2.
Save or copy the generated video exactly to: assets/examples/emotion-control-90s/shot_03.mp4.
Duration: 6 seconds.
Resolution: 720p.
