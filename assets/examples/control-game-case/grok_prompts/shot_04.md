...
Image 1, first frame: assets/examples/control-game-case/shot_04_first.png.
Image 2, tail frame: assets/examples/control-game-case/shot_04_tail.png.
...
New staged element or beat group: puppet strings loosen and figure steps outside range.
...
Save or copy the generated video exactly to: assets/examples/control-game-case/shot_04.mp4.
Duration: 6 seconds.
Resolution: 720p.
