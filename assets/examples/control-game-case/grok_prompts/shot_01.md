...
Image 1, first frame: assets/examples/control-game-case/shot_01_first.png.
Image 2, tail frame: assets/examples/control-game-case/shot_01_tail.png.
Prompt: Animate from image 1, the sparse first frame, toward image 2, the full tail frame, over 1.5 seconds.
Keep the camera, background, typography, shadows, and sticker style consistent.
New staged element or beat group: empty mustard editorial stage with arcade cabinet silhouette.
...
Palette: keep mustard yellow or nicotine-beige panel, black ink, faded coral, small teal accents consistent across all generated frames.
End on a stable frame close to image 2.
Save or copy the generated video exactly to: assets/examples/control-game-case/shot_01.mp4.
Duration: 6 seconds.
Resolution: 720p.
