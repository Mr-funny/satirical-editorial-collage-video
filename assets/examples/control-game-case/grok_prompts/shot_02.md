...
Image 1, first frame: assets/examples/control-game-case/shot_02_first.png.
Image 2, tail frame: assets/examples/control-game-case/shot_02_tail.png.
...
New staged element or beat group: rigged arcade cabinet labeled INSULT.
Micro-timeline:
...
Save or copy the generated video exactly to: assets/examples/control-game-case/shot_02.mp4.
Duration: 6 seconds.
Resolution: 720p.
